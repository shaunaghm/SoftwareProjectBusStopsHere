...
function pushBusData(busData){
	console.log("busDataPushed");
}
...
function saveBus(bus){
	...
	jsonfile.writeFile('stop3918_26_02_2018.json',jsonInfo,function(err){
...
function createSaveFile(){
	...
	jsonfile.writeFile('stop3918_26_02_2018.json',stopSaveInfo,function(err){
