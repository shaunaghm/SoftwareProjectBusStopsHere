...
module.exports = {  
    ...
    forceSaveStop: function(stopid){
        //updatingStopData(stopid);
    },
    setThing: function(){
        savedBusesDue = [22232131,231231];
    },
    logThing: function(){
        console.log(savedBusesDue);
    }
};
...
function getTimetable(req,res){
    ...
    res.sendFile('/home/team1/SoftwareProjectServer/public/timetable.html'); 
}
